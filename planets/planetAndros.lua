...
elseif shipQUEST == 7 then
  shipQUEST = 8
  avatar = love.graphics.newImage("assets/avatars/planetAndrosAvatar.png")
  Moan.speak(planets[XY]["name"], {"Don't...--don't worry about me...--I'm done for...--What you're looking for is in sector--55,..."},
  {image=avatar})

  planets[XY]["live"] = false

  avatar = love.graphics.newImage("assets/avatars/nif.png")
  Moan.speak(planets[XY]["name"], {"The planet...--it's...EXPLODED!"},
